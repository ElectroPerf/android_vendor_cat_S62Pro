...
if test -f /data/media/demo ; then
  log -p i -t migrate_legacy_obb_data "demo enable, migrate abort"
  exit 0
fi
...
# removed. because it'll cause obb disappear at first boot after demo mode was disable from demo user
